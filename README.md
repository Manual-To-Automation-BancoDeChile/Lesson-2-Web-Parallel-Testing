# Manual to Automation @ <a href="https://portales.bancochile.cl/personas"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/aa/Banco_de_Chile_Logo.png/800px-Banco_de_Chile_Logo.png" alt="BdB" height="27" /></a> - Lesson 2 - Parallel Testing and BrowserStack
...
```sh
git clone https://github.com/Manual-To-Automation-BancoDeChile/Lesson-2-Web-Parallel-Testing.git.
```
* Move into the directory that you just cloned by typing
```sh
cd Lesson-2-Web-Parallel-Testing
```
